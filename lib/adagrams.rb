...
def highest_score_from(unscored_words)
  ...
  first_ten_lettered_word = find_first_ten_lettered_word(max_scored_words)
  first_min_word = find_first_min_word(max_scored_words)

  any_ten_lettered_word?(max_scored_words) ?
  winning_word = first_ten_lettered_word : winning_word = first_min_word

  first_word_score = max_scored_words.values[0]
...
def any_ten_lettered_word?(max_words)
